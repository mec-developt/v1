  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      toast({
        ...
        description: "Selamat datang kembali di Tumbuh Ide Indonesia",
      });
      setLoading(false);
    }, 1500);
  };
          ...
          <CardContent className="space-y-6">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-2">
                  ...
                  />
                  <Label htmlFor="remember" className="text-sm text-muted-foreground dark:text-slate-300">
                    Ingat saya
                  </Label>
                </div>
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-background px-2 text-muted-foreground dark:text-slate-400">
                  Atau masuk dengan
                </span>
              </div>
            </div>
